...
<div class="ec_setup_row">
    ...
    <span class="ec_setup_row_button"><a href="admin.php?page=ec_adminv2&ec_page=store-setup&ec_panel=basic-setup&ec_action=add_store_page" class="ec_setup_button">CREATE PAGE</a></span>
</div>
...
<div class="ec_setup_row">
    ...
    <span class="ec_setup_row_button"><a href="admin.php?page=ec_adminv2&ec_page=store-setup&ec_panel=basic-setup&ec_action=add_account_page" class="ec_setup_button">CREATE PAGE</a></span>
</div>
...
<div class="ec_setup_row">
    ...
    <span class="ec_setup_row_button"><a href="admin.php?page=ec_adminv2&ec_page=store-setup&ec_panel=basic-setup&ec_action=add_cart_page" class="ec_setup_button">CREATE PAGE</a></span>
</div>
