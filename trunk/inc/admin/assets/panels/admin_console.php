...
<table align="left" width="95%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr id="ec_wordpress_content">
	...
	<tr>     
    <td height="55" colspan="2"><div class="ec_admin_page_title">Administrative Console Software</div><br /><p>The WordPress EasyCart administrative console software is available for Desktops and popular tablet and phone systems.  The administrative console software allows you to manage day to day operations of your store, including Orders, Products, Users, Marketing, and more!</p>
  ...
  <tr>
    ...
    <td width="600" align="center">
        <img src="<?php echo plugins_url('../images/wordpress_easycart.jpg', __FILE__); ?>" alt="iPad Administration Console" width="600" height="360" />
    </td>
    <td  style="padding: 15px;">
        ...
        <p><a href="http://www.wpeasycart.com/support-ticket/" target="_blank">Submit a ticket</a> with the url you are using and an agent will get back to you shortly.</p><br /><br />
    </td>
    <?php } ?>
  </tr>
