...
class mainmenu
	{		
		...
		function updatemenulevel1($keyfield, $menulevel1) {
			  ...
			  //Create SQL Query
			  $sql = sprintf("Replace into ec_menulevel1 (ec_menulevel1.menulevel1_id, ec_menulevel1.name, ec_menulevel1.clicks, ec_menulevel1.order) values ('".$keyfield."', '%s', '%s', '%s')",
		...
		function addmenulevel1($menulevel1) {
			  ...
			  //Create SQL Query
			  $sql = sprintf("Insert into ec_menulevel1(ec_menulevel1.menulevel1_id, ec_menulevel1.name, ec_menulevel1.clicks, ec_menulevel1.order)
				values(Null, '%s', '%s', '%s')",
				mysql_real_escape_string($menulevel1['menuname']),
				mysql_real_escape_string($menulevel1['clicks']),
				mysql_real_escape_string($menulevel1['menu1order']));
		...
		function updatemenulevel2($keyfield, $menulevel2) {
			  ...
			  //Create SQL Query
			  $sql = sprintf("Replace into ec_menulevel2(ec_menulevel2.menulevel2_id, ec_menulevel2.menulevel1_id, ec_menulevel2.name, ec_menulevel2.clicks, ec_menulevel2.order)
		...
		function addmenulevel2($menulevel2) {
			  ...
			  //Create SQL Query
			  $sql = sprintf("Insert into ec_menulevel2(ec_menulevel2.menulevel2_id, ec_menulevel2.menulevel1_id, ec_menulevel2.name, ec_menulevel2.clicks, ec_menulevel2.order)
				values(Null, '%s', '%s', '%s', '%s')",
				mysql_real_escape_string($menulevel2['menuparentid']),
				mysql_real_escape_string($menulevel2['menuname']),
				mysql_real_escape_string($menulevel2['clicks']),
		...
		function updatemenulevel3($keyfield, $menulevel3) {
			  ...
			  //Create SQL Query
			  $sql = sprintf("Replace into ec_menulevel3(ec_menulevel3.menulevel3_id, ec_menulevel3.menulevel2_id, ec_menulevel3.name, ec_menulevel3.clicks, ec_menulevel3.order)
				values('".$keyfield."', '%s', '%s', '%s', '%s')",
		...
		function addmenulevel3($menulevel3) {
			  ...
			  //Create SQL Query
			  $sql = sprintf("Insert into ec_menulevel3(ec_menulevel3.menulevel3_id, ec_menulevel3.menulevel2_id, ec_menulevel3.name, ec_menulevel3.clicks, ec_menulevel3.order)
				values(Null,  '%s', '%s', '%s', '%s')",
				mysql_real_escape_string($menulevel3['menuparentid']),
				mysql_real_escape_string($menulevel3['menuname']),
				mysql_real_escape_string($menulevel3['clicks']),
