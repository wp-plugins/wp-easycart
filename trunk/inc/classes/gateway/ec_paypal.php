...
class ec_paypal extends ec_third_party{
	...
	public function display_form_start( ){
		...
		echo "<input name=\"tax_cart\" id=\"tax_cart\" type=\"hidden\" value=\"" . number_format($this->order->tax_total, 2) . "\" />";
		...
		echo "<input name=\"address_override\" id=\"address_override\" type=\"hidden\" value=\"1\" />";
	...
	public function display_auto_forwarding_form( ){
		...
		echo "</form>";
		echo "<SCRIPT LANGUAGE=\"Javascript\">document.ec_paypal_standard_auto_form.submit();</SCRIPT>";
	}
