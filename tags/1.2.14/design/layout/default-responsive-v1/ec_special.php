<div class="ec_product item<?php echo $i+1; ?>">
  <div class="ec_product_images">
    <?php $product->display_product_image_set( "medium", "ec_image_specials_", "true; ec_image_click" ); ?>
  </div>
  ...
  <div style="width:35%; float:right;">
    <div class="ec_product_pricing">
      <?php $product->display_product_list_price(); ?>
      <?php $product->display_product_price(); ?>
    </div>
  </div>
</div>
