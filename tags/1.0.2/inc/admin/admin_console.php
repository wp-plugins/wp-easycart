      ...
      <tr>
        ...
        <!-- BEGIN EMBED CODE -->
          ...
          <script type="text/javascript">
                ...
                so.addVariable("appurl", "http://www.wpeasycart.com/air/wpadmin_v1_0_31.air"); // absolute URL (beginning with http or https) of the application ".air" file
                ...
                so.addVariable("appversion", "1.0.31"); // AIR application version
