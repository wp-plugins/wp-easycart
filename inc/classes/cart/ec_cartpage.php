...
class ec_cartpage{
	...
	function __construct( $is_affirm = false ){
		...
		// Shipping
		$this->shipping = new ec_shipping( $this->cart->shipping_subtotal, $this->cart->weight, $this->cart->shippable_total_items, 'RADIO', $this->user->freeshipping, $this->cart->length, $this->cart->width, $this->cart->height, $this->cart->cart );
		// Tax (no VAT here)
