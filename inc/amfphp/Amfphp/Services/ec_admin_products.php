...
class ec_admin_products{
	...
	function updateproduct( $productid, $product ){
		...
		$sql = "UPDATE ec_product SET 
				...
				is_shippable = %d, TIC = %s, subscription_signup_fee = %s, subscription_bill_duration = %s , handling_price_each = %s , allow_backorders = %s , backorder_fill_date = %s 
				WHERE product_id = %d";
		...
		$this->db->query( $this->db->prepare( $sql, 
				...
				$product->is_shippable,  $product->TIC, $product->subscription_signup_fee, $product->subscription_bill_duration, $product->handling_price_each, $product->allow_backorders, $product->backorder_fill_date,
