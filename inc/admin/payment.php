		...
		<table width="100%" cellpadding="0" cellspacing="0" class="form-table">
            ...
            <tr valign="top" id="live_gateways">
              ...
              <table width="90%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr valign="top" class="form-table" id="braintree">
                  <td height="116" colspan="2" scope="row"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                    <tr valign="top" class="form-table">
...
<script language="javascript" type="application/javascript">
			function toggle_live_gateways() {
				...
				if( paymentmethod == "braintree" ){
				   	document.getElementById( "braintree" ).style.display = "";
					toggle_live_card_display( 1, 0, 0, 1, 1, 0, 1, 1, 0, 0, 0 );
				}
...
<script language="javascript" type="application/javascript">
				function toggle_third_party() {
					...
					document.getElementById("paymentexpress_thirdparty").style.display = 'none';
					...
					}else if( paymentmethod == 'paymentexpress_thirdparty' ){
						document.getElementById( "paymentexpress_thirdparty" ).style.display = "";	
					}
