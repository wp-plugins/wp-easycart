...
if( current_user_can( 'manage_options' ) ){	
	require_once WP_PLUGIN_DIR . "/" . EC_PLUGIN_DIRECTORY . '/inc/classes/core/class-tgm-plugin-activation.php';
	add_action( 'tgmpa_register', 'wp_easycart_register_add_on_plugins' );
}
...
function ec_install_admin_notice() {
	if( current_user_can( 'manage_options' ) ){
		...
		if( is_plugin_active( "wp-easycart-admin/wpeasycart-admin.php" ) && EC_AD_CURRENT_VERSION != "3.0.19" ){
			?>
			<div class="error">
				<p>The latest WP EasyCart Store Admin version is 3.0.19, please update for best results!</p>
			</div>
			<?php
		}
