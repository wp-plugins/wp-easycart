<div class="ec_admin_mainmenu">
	<div class="ec_admin_mainmenu_inner">
        ...
        <div class="ec_admin_mainmenu_searcharea"><form method="GET" action="http://www.wpeasycart.com/search-plugin-information/" target="_blank"><input type="submit" value="Search Docs" /><input type="text" name="q" placeholder="Enter Your Search" /></form></div>
    </div>
</div>