...
<div class="ec_admin_leftmenu">
    <div class="ec_admin_leftmenu_inner arrow_pos_1">
        ...
        <div class="ec_admin_leftmenu_item<?php if( !isset( $_GET['ec_panel'] ) ){ echo "_selected"; } ?>"><a href="admin.php?page=ec_adminv2&ec_page=dashboard">Plugin Information</a></div>
        <?php }?>
