<div class="ec_payment_type_holder<?php if( get_option( 'ec_option_payment_third_party' ) != "nets" ){ echo '_inactive'; } ?>" id="nets">
    ...
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Nets Shared Secret (Token):</span><span class="ec_payment_type_row_input"><input name="ec_option_nets_token" id="ec_option_nets_token" type="text" value="<?php echo get_option('ec_option_nets_token'); ?>" style="width:400px;" /></span></div>
