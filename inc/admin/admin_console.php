...
<div class="ec_contentwrap">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <!-- BEGIN EMBED CODE -->
          ...
          <script type="text/javascript">
                ...
                so.addVariable("appurl", "http://www.wpeasycart.com/air/wpadmin_v1_0_40.air"); // absolute URL (beginning with http or https) of the application ".air" file
                ...
                so.addVariable("appversion", "1.0.40"); // AIR application version
      ...
      <tr>
        <td height="37" align="center"><strong>Problems Downloading?</strong> Try manually installing by following these <a href="http://www.wpeasycart.com/air-install" target="_blank">2 steps to install.</a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td width="600">&nbsp;</td>
