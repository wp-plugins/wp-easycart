...
CREATE TABLE IF NOT EXISTS `ec_optionitem` (
  ...
  `optionitem_name` VARCHAR(64) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 
   'Name of this optionitem.',
  `optionitem_price` FLOAT(15,3) NOT NULL DEFAULT 0.000 COMMENT
   'Price change value for an optionitem.',
  `optionitem_price_onetime` FLOAT(15,3) NOT NULL DEFAULT 0.000 COMMENT 
   'Price change one-time addition to total price.',
  `optionitem_price_override` FLOAT(15,3) NOT NULL DEFAULT -1.000 COMMENT 
   'Price change to override product price.',
  `optionitem_weight` FLOAT(15,3) NOT NULL DEFAULT 0.000 COMMENT 
   'Weight change value for an optionitem.',
  `optionitem_weight_onetime` FLOAT(15,3) NOT NULL DEFAULT 0.000 COMMENT 
   'Weight change one-time addition to total weight.',
  `optionitem_weight_override` FLOAT(15,3) NOT NULL DEFAULT -1.000 COMMENT 
   'Weight change to override product weight.',
  `optionitem_order` INTEGER(11) NOT NULL DEFAULT 1 COMMENT
   'Gives a user selected order of display for the optionitems.',
  `optionitem_icon` VARCHAR(512) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT
   'Gives the optionitem an icon for displaying optionitem swatch sets.',
  `optionitem_initial_value` VARCHAR(64) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 
   'For some options an initial value is useful.',
...
CREATE TABLE IF NOT EXISTS `ec_orderdetail` (
  ...
  `use_advanced_optionset` TINYINT(1) NOT NULL DEFAULT 0 COMMENT
   'Used for display purposes to notify if this item uses advanced option sets.',
  `giftcard_id` VARCHAR(20) COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT
...
CREATE TABLE IF NOT EXISTS `ec_product` (
  ...
  `option_id_5` INTEGER(11) NOT NULL DEFAULT 0 COMMENT
   'Relates the selected option choice to ec_option.',
  `use_advanced_optionset` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 
   'If true, uses the advanced, unlimited option set type.',
...
CREATE TABLE IF NOT EXISTS `ec_shippingrate` (
  ...
  `zone_id` INTEGER(11) NOT NULL DEFAULT 0 COMMENT
   'References the ec_zone table for zoned shipping rates.',
  ...
  `is_dhl_based` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 
   'If selected, the live rate system for DHL.',
