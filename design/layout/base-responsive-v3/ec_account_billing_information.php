<div id="ec_account_billing_information">
  ...
  <div class="ec_account_billing_information_holder">
    ...
    <div class="ec_account_billing_information_row" id="ec_account_billing_information_company_name_row">
		<div class="ec_account_billing_information_label"><?php echo $GLOBALS['language']->get_text( 'cart_billing_information', 'cart_billing_information_company_name' ); ?></div>
		<div class="ec_account_billing_information_input">
		<input type="text" name="ec_account_billing_information_company_name" id="ec_account_billing_information_company_name" class="ec_account_billing_information_input_field" value="<?php echo $this->user->billing->company_name; ?>">
		</div>
	</div>
	<?php } ?>
    ...
    <div class="ec_account_billing_information_row" id="ec_account_billing_information_address2_row">
