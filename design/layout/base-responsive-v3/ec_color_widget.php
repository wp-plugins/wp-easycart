	...
	<div class="ec_details_option_row">
        ...
        <ul class="ec_details_swatches">
            ...
            <?php foreach( $optionitems as $optionitem ){ ?>
       			...
       			<li class="ec_details_swatch ec_option ec_active<?php if( isset( $_GET['optionitem_id'] ) && $_GET['optionitem_id'] == $optionitem->optionitem_id ){ echo " ec_selected"; } ?>">
                	<a href="<?php echo $filter->get_link_string( 7 ) . "&amp;optionitem_id=" . $optionitem->optionitem_id; ?>">
