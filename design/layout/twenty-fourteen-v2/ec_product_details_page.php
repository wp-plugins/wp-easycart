...
<div class="ec_product_details_page">
    ...
    <div class="ec_product_details_right_side">
    	...
    	<div class="ec_product_details_below_title_row">
    		<div class="ec_product_details_model_number"><?php $this->product->display_model_number( ); ?></div>
		...
		<?php if( $this->product->get_price_tier_price_string( ) != "" ){ ?>
    	...
    	<?php if( !$this->product->has_grid_optionset ){ ?>
