<div class="ec_product_quick_view_box_holder" id="ec_product_quick_view_box_<?php echo $product->model_number; ?>">
    ...
    <div class="ec_product_quick_view_box_content_holder">
        ...
        <div class="ec_product_quick_view_box_content_right">
            ...
            <div class="ec_product_quick_view_box_content_row"><span class="subtitle"><?php echo "MODEL: " . $product->model_number; ?> | <?php $product->display_product_link( $GLOBALS['language']->get_text( 'quick_view', 'quick_view_view_full_details' ) ); ?></span></div>
            ...
            <?php }else{ ?>
                <div class="ec_product_quick_view_box_content_row2"><div><?php $product->display_product_list_price(); ?></div><div><?php $product->display_price(); ?></div></div>
