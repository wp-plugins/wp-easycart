<div id="ec_account_dashboard">
  <div class="ec_account_dashboard_holder_main">
    <div class="ec_account_dashboard_left">
      <div class="ec_account_dashboard_title"><?php echo $GLOBALS['language']->get_text( 'account_dashboard', 'account_dashboard_recent_orders_title' )?></div>
      <div class="ec_account_dashboard_holder">
      ...
      <div class="ec_account_dashboard_title"><?php echo $GLOBALS['language']->get_text( 'account_dashboard', 'account_dashboard_preference_title' )?></div>
      <div class="ec_account_dashboard_holder">
        <div class="ec_account_dashboard_row_bold"><?php echo $GLOBALS['language']->get_text( 'account_dashboard', 'account_dashboard_email_title' )?></div>
        <div class="ec_account_dashboard_row_content" id="ec_account_dashboard_email">
          <?php $this->user->display_email(); ?>
        </div>
        ...
        <div class="ec_account_dashboard_row_bold"><b><?php echo $GLOBALS['language']->get_text( 'account_dashboard', 'account_dashboard_billing_title' )?></b></div>
        <?php if( $this->user->billing->first_name || $this->user->billing->last_name ){ ?>
        <div class="ec_account_dashboard_row_content" id="ec_account_dashboard_billing_name">
          <?php $this->user->billing->display_first_name(); ?>
          <?php $this->user->billing->display_last_name(); ?>
        </div>
        <?php } ?>
        <?php if( $this->user->billing->address_line_1 ){ ?>
        <div class="ec_account_dashboard_row_content" id="ec_account_dashboard_billing_address_line_1">
        ...
        <div class="ec_account_dashboard_row_content" id="ec_account_dashboard_billing_country">
          <?php $this->user->billing->display_country(); ?>
        </div>
        <?php } ?>
        <?php if( $this->user->billing->phone ){ ?>
        <div class="ec_account_dashboard_row_content" id="ec_account_dashboard_billing_phone">
        ...
        <div class="ec_account_dashboard_row_content" id="ec_account_dashboard_shipping_country">
          <?php $this->user->shipping->display_country(); ?>
        </div>
        <?php } ?>
        <?php if( $this->user->shipping->phone ){ ?>
        <div class="ec_account_dashboard_row_content" id="ec_account_dashboard_shipping_phone">
    ...
    <div class="ec_account_dashboard_right">
      <div class="ec_account_dashboard_title"><?php echo $GLOBALS['language']->get_text( 'account_navigation', 'account_navigation_title' )?></div>
      <div class="ec_account_dashboard_holder">
        <div class="ec_account_dashboard_row_content">
