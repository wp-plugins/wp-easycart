  ...
  <div class="ec_cart_login_holder">
    ...
    <div class="ec_cart_login_right">
      <div class="ec_cart_header_right">
        <div class="ec_cart_login_title"><?php echo $GLOBALS['language']->get_text( 'cart_subscription_guest_checkout', 'cart_subscription_guest_title' )?></div>
        <div class="ec_cart_login_subtitle"><?php echo $GLOBALS['language']->get_text( 'cart_subscription_guest_checkout', 'cart_subscription_guest_sub_title' )?></div>
      </div>
      <div class="ec_cart_login_row"><?php echo $GLOBALS['language']->get_text( 'cart_subscription_guest_checkout', 'cart_subscription_guest_message' )?></div>
      <div class="ec_cart_login_row">
        <?php $this->display_cart_login_guest_button( $GLOBALS['language']->get_text( 'cart_subscription_guest_checkout', 'cart_subscription_guest_button' ) ); ?>
      </div>
    </div>
